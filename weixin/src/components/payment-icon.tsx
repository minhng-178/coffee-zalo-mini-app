...
// Original wrapped zmp-ui's <Spinner> with Tailwind arbitrary-variant classes
// targeting zmp-ui's internal `.zaui-spinner`/`.zaui-spinner-logo` classes,
// which don't exist in components/ui's Spinner. Simplified here to a plain
// flex-centered box holding the payment logo, dropping the spin animation —
// matches the sibling success/fail icons' layout pattern below.
export function IconPaymentLoading() {
  return (
    <View className="w-[100px] h-[100px] flex items-center justify-center">
      <IconPayment />
    </View>
  );
}
