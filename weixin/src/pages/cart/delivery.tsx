...
import { Box, Icon, Radio, Text } from "components/ui";
...
export const Delivery: FC = () => {
  ...
  const [fulfillmentType, setFulfillmentType] = useRecoilState(fulfillmentTypeState);
  ...
  return (
    <Box className="space-y-3 px-4">
      ...
      <Radio.Group
        ...
        onChange={(value: string) => setFulfillmentType(value as "pickup" | "delivery")}
      />
      <ListRenderer
        items={[
          {
            ...
            right: (
              <Box flex>
                <ElasticTextarea
                  ...
                  className="border-none px-0 w-full"
                  maxRows={4}
                  value={note}
